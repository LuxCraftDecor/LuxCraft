            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative">
                <div className="max-w-xl mx-auto text-center">
                    <div className="inline-flex px-4 py-1.5 mx-auto rounded-full  ">
                        <p className="text-4xl font-semibold tracking-widest  uppercase">Limited Edition:</p>
                    </div>
                    <p className="mt-4 text-base leading-relaxed text-gray-600 group-hover:text-white">Limited Edition Prints are a series of identical prints of an artwork, commissioned by the artist. Restricted to a one-time printing of a certain number of pieces, each print is numbered and signed by the artist, establishing its’ authenticity.</p>
                </div>
                <div className="grid grid-cols-1 gap-2 mt-12 sm:grid-cols-3 lg:mt-20   ">
                    ...
                    <a href="#"
                        ...
                        <div className="py-2 px-9 relative  ">
                            <svg className="w-16 h-16 fill-gray-400 group-hover:fill-white" version="1.1" id="Capa_1"
                    ...
                    <a href="#"
                        ...
                        <div className="py-2 px-9 relative  ">
                            <svg className="w-16 h-16 fill-gray-400 group-hover:fill-white" viewBox="0 0 32 32"
                    ...
                    <a href="#"
                        ...
                        <div className="py-2 px-9 relative  ">
                            <svg className="w-16 h-16 fill-gray-400 group-hover:fill-white" viewBox="0 0 14 14"
                    ...
                    <a href="#"
                        ...
                        <div className="py-2 px-9 relative  ">
                            <svg className="w-16 h-16 fill-gray-400 group-hover:fill-white" viewBox="-3.9 0 57.791 57.791"
                                xmlns="http://www.w3.org/2000/svg">
